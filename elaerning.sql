CREATE DATABASE  IF NOT EXISTS `elearning_upload` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `elearning_upload`;
-- MySQL dump 10.13  Distrib 5.5.40, for debian-linux-gnu (x86_64)
--
-- Host: 127.0.0.1    Database: elearning_upload
-- ------------------------------------------------------
...
CREATE TABLE `materi_file` (
  `id_materi_file` int(11) NOT NULL AUTO_INCREMENT,
  `isi_file` longblob,
  `nama` varchar(100) DEFAULT NULL,
  `id_materi` varchar(45) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `modified_date` datetime DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `modified_by` int(11) DEFAULT NULL,
  `content_type` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id_materi_file`)
...
LOCK TABLES `materi_file` WRITE;
/*!40000 ALTER TABLE `materi_file` DISABLE KEYS */;
/*!40000 ALTER TABLE `materi_file` ENABLE KEYS */;
UNLOCK TABLES;
